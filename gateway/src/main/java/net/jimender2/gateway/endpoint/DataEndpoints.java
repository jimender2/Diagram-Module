package net.jimender2.gateway.endpoint;
...
public final class DataEndpoints {
    ...
    public static void mountRoutes(RouteGroup routes) {
        // creates a new data route reachable at
        // host:port/main/data/radcomppnents/component/tagcount
     ...
     * </pre>
     *
     * Tag counts are cached and re-caclcated no more often than
     * {@link DataEndpoints#CACHE_DURATION_MS}.
     *
     * Note: an 'ideal' implementation of this sort would require some additional
     * concurrency handling for optimal
     * performance and safety, but was skipped to keep example focused on big
