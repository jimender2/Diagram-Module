package net.jimender2.common.component.display;
...
public class Diagram {
    ...
    public static String COMPONENT_ID = "net.jimender2.diagram";

    /**
     * The schema provided with the component descriptor. Use a schema instead of a
     * plain JsonObject because it gives
     * us a little more type information, allowing the designer to highlight
     * mismatches where it can detect them.
     */
    public static JsonSchema SCHEMA = JsonSchema
            .parse(RadComponents.class.getResourceAsStream("/diagram.props.json"));
    ...
    public static ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
            ...
            .setName("Diagram")
            .addPaletteEntry("", "Diagram", "Custom Diagrams", null, null)
            .setDefaultMetaName("")
