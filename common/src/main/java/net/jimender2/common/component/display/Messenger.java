...
public class Messenger {
    ...
    static {
        // JsonSchemas can also be constructed from Gson classes directly, but it's
    ...
    public static ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
            ...
            .setEvents(
                    List.of(new ComponentEventDescriptor("onMessageEvent", "Description of your event", EVENT_SCHEMA)))
